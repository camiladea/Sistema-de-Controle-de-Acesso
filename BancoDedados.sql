...
CREATE TABLE IF NOT EXISTS Usuario (
    ...
    -- Agora armazena diretamente o template biométrico (FIR codificado em texto)
    digitalFIR LONGTEXT NOT NULL COMMENT 'Armazena o template FIR do SDK Nitgen',
...
-- 3. Tabela de registros de acesso
...
INSERT INTO Usuario (nome, cpf, email, tipoUsuario, ativo, login, senhaHash, digitalFIR)
VALUES 
