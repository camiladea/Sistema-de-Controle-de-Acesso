...
public class TelaAutenticacao extends JFrame {
   ...
   public TelaAutenticacao(TerminalController controller) {
       ...
       labelStatus.setFont(new Font("Segoe UI", Font.BOLD, 41));
   ...
   private void configurarJanela() {
       ...
       setSize(1128, 785); // Altura pode ser reduzida pois não há imagem
   ...
   private JButton criarBotaoAdmin() {
       ...
       botao.setFont(new Font("Segoe UI", Font.BOLD, 27));
